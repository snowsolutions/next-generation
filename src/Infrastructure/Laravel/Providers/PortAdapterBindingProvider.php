...
use Src\Entities\Account\Interactors\DeleteInteractor as AccountDeleteInteractor;
use Src\Entities\Account\Interactors\GetListInteractor as AccountGetListInteractor;
use Src\Entities\Account\Interactors\UpdateInteractor as AccountUpdateInteractor;
use Src\Entities\Account\Interactors\ViewInteractor as AccountViewInteractor;
...
use Src\Entities\Campaign\Interactors\DeleteInteractor as CampaignDeleteInteractor;
use Src\Entities\Campaign\Interactors\GetListInteractor as CampaignGetListInteractor;
use Src\Entities\Campaign\Interactors\InsertBulkInteractor as CampaignInsertBulkInteractor;
use Src\Entities\Campaign\Interactors\UpdateInteractor as CampaignUpdateInteractor;
use Src\Entities\Campaign\Interactors\ViewInteractor as CampaignViewInteractor;
use Src\Entities\Lead\Domains\Contracts\LeadRepositoryContract;
use Src\Entities\Lead\Interactors\DeleteInteractor as LeadDeleteInteractor;
use Src\Entities\Lead\Interactors\GetListInteractor as LeadGetListInteractor;
use Src\Entities\Lead\Interactors\UpdateInteractor as LeadUpdateInteractor;
use Src\Entities\Lead\Interactors\ViewInteractor as LeadViewInteractor;
